...
<body class="gradient">
  ...
  <div>
    ...
    <div>
        <a class='button' href='theme_add.php?branchId=<? echo $_GET['branchId']; ?>' style='margin: auto; display: block; width: 80%; text-decoration: none; text-align: center; margin-bottom: 25px;'>[+] Add Theme</a>
        <?php display_forum(2); ?>
    </div>
  </div>
